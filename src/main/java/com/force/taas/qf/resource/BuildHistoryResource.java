...
public class BuildHistoryResource {
	...
	@PathParam("{buildHistoryKey}")
	public BuildHistory doGetBuildHistory(@PathParam("buildHistoryKey") String buildHistoryKey) throws Exception {
		return PersistenceService.getBucket().fetch(buildHistoryKey, BuildHistory.class).execute();
	}
